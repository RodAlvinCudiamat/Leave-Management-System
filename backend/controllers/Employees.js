...
class Employees {
     ...
     */
    static fetchAllEmployees = async (req, res) => {
        try{
     ...
     * @lastupdated September 26, 2025
     */
    static insertEmployee = async (req, res) => {
        ...
        try{
            ...
            const employee_id = created_employee.result.employee_id;
            
            /* Grant all active leave types */
            const grant_leaves = await LeaveServices.grantRegularLeaveTypes(employee_id, conn);
            ...
            await conn.commit();
            return res.json({ success: true, message: "Employee created and grant leave types successfully", employee_id });
        } 
        catch(err){
            await conn.rollback();
            return res.json({ success: false, error: err.message });
     ...
     * @lastupdated September 26, 2025
     */
    static softDeleteEmployees = async (req, res) => {
        try{
            const { id } = req.params;
     ...
     * @lastupdated September 26, 2025
     */
    static fetchEmployeeById = async (req, res) => {
        try{
            const { id } = req.params;
     ...
     * @lastupdated September 26, 2025
     */
    static fetchCurrentEmployee = async (req, res) => {
        try{
            if(!req.session.user){
