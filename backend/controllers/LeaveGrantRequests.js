...
class LeaveGrantRequests {
     ...
     */
    static insertLeaveGrantRequest = async (req, res) => {
     ...
     * @lastupdated September 25, 2025
     */
    static fetchAllLeaveGrantRequests = async (req, res) => {
        try{
     ...
     * @lastupdated September 25, 2025
     */
    static updateLeaveGrantRequest = async (req, res) => {
        ...
        try{
            ...
            if(leave_application_status_id === APPLICATION_STATUS.APPROVED){
                ...
                const grant_response = await LeaveServices.grantSpecialLeaveTypes(employee_id, leave_type_id, conn); 
...
export default LeaveGrantRequests;
