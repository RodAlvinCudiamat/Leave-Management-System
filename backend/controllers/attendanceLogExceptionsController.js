import AttendanceLogExceptions from "../models/attendanceLogExceptionModel.js";
 ...
 */
export const fetchAllLogExceptions = async (req, res) => {
    try{
        const log_exceptions = await AttendanceLogExceptions.fetchLogExceptions();
