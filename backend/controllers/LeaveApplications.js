...
import { validateLeaveDates } from "../helpers/LeaveDatesRules.js";
...
class LeaveApplications {
     ...
     */
    static insertLeaveApplication = async (req, res) => {
        try {
     ...
     */
    static fetchLeaveApplicationById = async (req, res) => {
        try{
            const { id } = req.params;
     ...
     * @lastupdated September 25, 2025
     */
    static fetchAllLeaveApplications = async (req, res) => {
        try{
            const { employee_id } = req.params; // Optional filter by employee_id
            const all_leave_applications = await LeaveApplication.fetchAllLeaveApplications(employee_id);
     ...
     * @lastupdated September 25, 2025
     */
    static updateLeaveApplication = async (req, res) => {
        try{
            const { id } = req.params;
